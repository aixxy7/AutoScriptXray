...
|        Link         |  Command  |
|---------------------|-------------------|
| via WGET | `bash -c "$(wget -qO- https://raw.githubusercontent.com/aixxy7/AutoScriptXray/main/xray)"` |
| via CURL | `bash -c "$(curl -fsSL https://raw.githubusercontent.com/aixxy7/AutoScriptXray/main/xray)"` |
